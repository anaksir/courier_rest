...
class CompleteTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.data = {
            'courier_id': 1,
            'order_id': 1,
            'complete_time': '2021-03-29T14:45:00.161978Z'
        }
        self.success_data = {'order_id': 1}
        self.invalid_data = {
            'courier_id': 1,
            'order_id': 111,
            'complete_time': '2021-03-29T14:30:01.161978Z'
        }
        self.url = reverse('orders-complete')

    def test_assign_orders(self):
        """
        Проверка выполнения курьером заказа
        """
